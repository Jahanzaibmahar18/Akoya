...
const Navbar = () => {
  ...
  const bluePages = ["/contact", "/VisionMission"];

  const isBluePage = bluePages.includes(location.pathname);

  useEffect(() => {
    if (isBluePage) return;
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <ul className="hidden md:flex items-center space-x-8 text-white font-medium">
            ...
            <li><Link to="/VisionMission">VisionMission</Link></li>
